...
class AppNavigationScreen extends StatelessWidget {
                      ...
                      child: SingleChildScrollView(
                          child: Container(
                              ...
                              child: Column(children: [
                                ...
                                GestureDetector(
                                    onTap: () {
                                      onTapIPhone14OneContainer(context);
                                    },
                                    child: Container(
                                        decoration:
                                            AppDecoration.fillOnSecondary,
                                ...
                                GestureDetector(
                                    onTap: () {
                                      onTapIPhone14ThreeTabContainer(context);
                                    },
                                    child: Container(
                                        decoration:
                                            AppDecoration.fillOnSecondary,
                                ...
                                GestureDetector(
                                    onTap: () {
                                      onTapIPhone14EightTabContainer(context);
                                    },
                                    child: Container(
                                        decoration:
                                            AppDecoration.fillOnSecondary,
                                ...
                                GestureDetector(
                                    onTap: () {
                                      onTapIPhone14FifteenTabContainer(context);
                                    },
                                    child: Container(
                                        decoration:
                                            AppDecoration.fillOnSecondary,
                                ...
                                GestureDetector(
                                    onTap: () {
                                      onTapIPhone14TwentyEightTabContainer(
                                          context);
                                    },
                                    child: Container(
                                        decoration:
                                ...
                                GestureDetector(
                                    onTap: () {
                                      onTapIPhone14NineteenTabContainer(
                                          context);
                                    },
                                    child: Container(
                                        decoration:
                                ...
                                GestureDetector(
                                    onTap: () {
                                      onTapIPhone14TwentyTwo(context);
                                    },
                                    child: Container(
                                        decoration:
                                            AppDecoration.fillOnSecondary,
                                ...
                                GestureDetector(
                                    onTap: () {
                                      onTapIPhone14TwentyThreeTabContainer(
                                          context);
                                    },
                                    child: Container(
                                        decoration:
                                ...
                                GestureDetector(
                                    onTap: () {
                                      onTapIPhone14TwentyFive(context);
                                    },
                                    child: Container(
                                        decoration:
                                            AppDecoration.fillOnSecondary,
                                ...
                                GestureDetector(
                                    onTap: () {
                                      onTapIPhone14TwentySix(context);
                                    },
                                    child: Container(
                                        decoration:
                                            AppDecoration.fillOnSecondary,
  ...
  /// Navigates to the iphone14OneContainerScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the [Navigator] widget
  /// to push the named route for the iphone14OneContainerScreen.
  onTapIPhone14OneContainer(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.iphone14OneContainerScreen);
  }
  ...
  onTapIPhone14ThreeTabContainer(BuildContext context) {
  ...
  onTapIPhone14EightTabContainer(BuildContext context) {
  ...
  /// Navigates to the iphone14FifteenTabContainerScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the [Navigator] widget
  /// to push the named route for the iphone14FifteenTabContainerScreen.
  onTapIPhone14FifteenTabContainer(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.iphone14FifteenTabContainerScreen);
  }

  /// Navigates to the iphone14TwentyeightTabContainerScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the [Navigator] widget
  /// to push the named route for the iphone14TwentyeightTabContainerScreen.
  onTapIPhone14TwentyEightTabContainer(BuildContext context) {
    Navigator.pushNamed(
        context, AppRoutes.iphone14TwentyeightTabContainerScreen);
  }

  /// Navigates to the iphone14NineteenTabContainerScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the [Navigator] widget
  /// to push the named route for the iphone14NineteenTabContainerScreen.
  onTapIPhone14NineteenTabContainer(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.iphone14NineteenTabContainerScreen);
  }
  ...
  onTapIPhone14TwentyTwo(BuildContext context) {
  ...
  onTapIPhone14TwentyThreeTabContainer(BuildContext context) {
    Navigator.pushNamed(
  ...
  onTapIPhone14TwentyFive(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.iphone14TwentyfiveScreen);
  }

  /// Navigates to the iphone14TwentysixScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the [Navigator] widget
  /// to push the named route for the iphone14TwentysixScreen.
  onTapIPhone14TwentySix(BuildContext context) {
